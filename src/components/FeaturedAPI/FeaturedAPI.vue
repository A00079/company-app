<template>
  <section class="text-gray-600 body-font">
    <div class="hidden md:block lg:block xl:block">
      ...
      <img class="w-96 h-96 absolute left-0" src="/img/webpointer-left.svg" />
    </div>
      ...
      <section class="text-gray-600 body-font">
        <div class="container px-5 py-2 mx-auto">
          <div class="flex flex-col text-center w-full mb-12">
            <h1
              class="sm:text-3xl tracking-tight font-extrabold text-left text-4xl font-medium title-font text-white"
            >
              <span style="color: rgb(0, 210, 91)">Featured API's</span> of this
              week
            </h1>
          ...
          <div class="flex flex-wrap -m-2">
            <div class="p-2 lg:w-1/3 md:w-1/2 w-full">
              <div
                class="h-full flex items-center bg-gray-900 shadow-lg border-gray-900 border p-4 rounded-lg"
              >
                <img
                  alt="team"
