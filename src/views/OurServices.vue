        ...
        >
          <div>
            <h2 class="text-3xl font-semibold text-gray-800 md:text-4xl">
              <span style="color: #00d25b">Build Your New </span>
              <span class="text-indigo-600"> Idea</span>
            </h2>
...
<script>
import OurServices from "../components/OurServicesComponents/OurServices/OurServices.vue";
export default {
  data() {
    return {};
  },
