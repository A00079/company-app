<template>
  ...
  <div class="mt-4">
    <div class="bg-transparent md:overflow-hidden">
      <div class="px-4 py-20 md:py-4">
        <div class="md:max-w-6xl md:mx-auto">
          <div class="md:flex md:flex-wrap">
            <div class="md:w-1/2 text-center md:text-left md:pt-16 h-72">
              <!-- <h1
            ...
            <div class="md:w-1/2 relative">
              <div class="hidden md:block">
                <div
                  class="-ml-24 -mb-40 absolute left-0 bg-white bottom-0 w-40 rounded-lg shadow-lg px-6 py-8"
                ...
                <div
                  class="-ml-40 mb-16 absolute left-0 bottom-0 w-40 bg-white rounded-lg shadow-lg px-6 py-8"
                  style="transform: rotate(-8deg)"
                >
                  <div
                    class="bg-indigo-800 mx-auto rounded-lg px-2 pb-2 relative mb-8"
                ...
                <div
                  class="-ml-96 absolute left-0 bottom-0 w-48 bg-white rounded-lg shadow-lg px-10 py-8"
                  style="
                    transform: rotate(-8deg);
                    z-index: 2;
                    margin-bottom: -80px;
      ...
      <svg
        class="fill-current text-transparent hidden md:block"
